...
<body>
    ...
    <nav>
        <div class="nav-wrapper brown lighten-2 white-text">
            <a href="https://www.fema.edu.br" class="brand-logo right">
                <img class="materialboxed" src="/lpphpadst226/images/logoagro.jpeg" height="63" width="180">
            </a>
            ...
            <ul id="slide-out" class="sidenav light-blue darken-3 white-text">
                ...
                <li><a href="/lpphpadst226/view/home.php" class="white-text">HOME</a></li>
                <li><a href="/lpphpadst226/VIEW/agricultor/lstAgricultor.php" class="white-text"><i class="material-icons white-text">people</i>Agricultor</a></li>
